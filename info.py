...
BOT_TOKEN = environ.get('BOT_TOKEN', "5888173541:AAG6CeFLGPnb8hfM3YqPqN2q_BoFZD06jBo")
...
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "<b>𝙁𝙞𝙡𝙚 𝙉𝙖𝙢𝙚 :</b><code>{file_name}</code>\n\n<b>𝙁𝙞𝙡𝙚 𝙎𝙞𝙯𝙚 :</b> {file_size}")
