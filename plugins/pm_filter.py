...
async def next_page(bot, query):
    api = "e26a4941b768ea742e459984b7f73a3f10a3b027"
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0,
        [
            InlineKeyboardButton(text="⚡ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://t.me/VijayTG_Updates/7')
        ]
    )
...
async def advantage_spell_chok(msg):
    ...
    await msg.reply(f"`Hey, {msg.from_user.mention}! I couldn't find anything related to {msg.text}\n Did you mean any one of these below 👇 ?`",
                    reply_markup=InlineKeyboardMarkup(btn))
